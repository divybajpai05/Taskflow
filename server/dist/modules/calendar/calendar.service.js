...
class CalendarService {
    ...
    async getCalendarTasks(workspaceId, userId, userPermissions, userTeamId) {
        ...
        const allTasks = await drizzle_1.db
            ...
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.tasks.workspaceId, workspaceId), (0, drizzle_orm_1.isNotNull)(schema_1.tasks.dueDate), ...taskFilter));
     ...
     */
    async moveTaskDueDate(taskId, newDueDate, userId, workspaceId) {
    ...
    async getAllCalendarEvents(workspaceId, userId, userPermissions, userTeamId) {
        ...
        if (canSeeLeaveCards && userTeamId) {
            ...
            if (teamMemberIds.length > 0) {
                const leaveConditions = [
                    ...
                    (0, drizzle_orm_1.inArray)(schema_1.leaves.userId, teamMemberIds),
                ];
        ...
        const attendanceRecords = await drizzle_1.db
            ...
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.attendance.workspaceId, workspaceId), (0, drizzle_orm_1.eq)(schema_1.attendance.userId, userId), (0, drizzle_orm_1.gte)(schema_1.attendance.date, startOfMonth), (0, drizzle_orm_1.lte)(schema_1.attendance.date, endOfMonth)));
